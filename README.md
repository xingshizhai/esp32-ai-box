...
| `anti-pet` | 十神 | ESP32-S3-LCD-EV-BOARD-2 | `/dev/ttyUSB0` | 屏幕“挑战小智”按钮 |
...
2. 点击“挑战小智”。
3. 确认十神生成一个简短的压力测试问题并通过扬声器播放。
4. 确认设备没有重启，并在结束后回到空闲状态。
...
4. 先让小智进入聆听状态，再点击十神的“挑战小智”。
5. 等小智回答完毕后，再启动十神的下一轮挑战。
